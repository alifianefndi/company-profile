  ...
  return (
    ...
    >
      ...
      <ScrollReveal
        ...
        className="flex flex-col items-center gap-4 text-center md:items-start md:text-start"
      >
        ...
        <p className="text-lg md:text-base lg:text-lg">
          ...
          cum et a quis non nesciunt quidem sint, vero natus provident quam
          autem animi eaque quos qui molestiae accusamus suscipit?
        </p>
      </ScrollReveal>
    </section>
  );
