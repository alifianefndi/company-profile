...
export function HeroSection() {
  return (
    <section
      id="home"
      className="relative w-full min-h-130 flex justify-center items-center overflow-hidden"
    >
      <Image
      ...
      <div className="container mx-auto absolute inset-0 flex justify-center items-center">
        <div className="text-center px-4 py-8 md:max-w-2xl md:px-8 md:py-16 lg:max-w-3xl">
          ...
          <p className="md:text-lg lg:text-xl mx-auto mb-6">
            PT Teman Berkah Sentosa delivers mission-critical systems, emerging
            technology, and hardened security — designed, deployed, and
            supported for Indonesian organizations that cannot afford downtime.
          </p>
